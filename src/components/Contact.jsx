        ...
        >
          <label className='flex flex-col'>
            ...
            <input
              ...
              className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white arounded-lg outline-none focus:outline-none focus:ring-2 border-none font-medium'
            />
          </label>
          <label className='flex flex-col'>
